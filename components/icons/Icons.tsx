...
export const MixamoIcon: React.FC<IconProps> = (props) => (
...
export const BlenderIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M13.23 4.41L.61 9.94l11.14 11.14c1.24 1.24 3.25 1.24 4.49 0l7.12-7.12c1.24-1.24 1.24-3.25 0-4.49L13.23 4.41zM5.5 12c-.83 0-1.5-.67-1.5-1.5S4.67 9 5.5 9s1.5.67 1.5 1.5S6.33 12 5.5 12z" />
    </svg>
);
export const UnityIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M21.8,10.2L12,4.8L2.2,10.2l2.6,1.5l7.2-4.2l7.2,4.2L21.8,10.2z M12,14.5l-4.8-2.8l-2.6,1.5L12,19.2l7.4-4.3l-2.6-1.5 L12,14.5z M4.8,14.8l4.8,2.8v4.8L2.2,18.2V13.3L4.8,14.8z M19.2,14.8l-4.8,2.8v4.8l7.4-4.3V13.3L19.2,14.8z" />
    </svg>
);
export const UnrealIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15c-2.76 0-5-2.24-5-5s2.24-5 5-5v10zm0-12c-3.87 0-7 3.13-7 7s3.13 7 7 7v-2c-2.76 0-5-2.24-5-5s2.24-5 5-5V5z" />
    </svg>
);
